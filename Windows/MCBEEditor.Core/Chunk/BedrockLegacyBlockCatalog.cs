...
/// <summary>Legacy Bedrock numeric block ID bridge ported from the iOS catalog.</summary>
public static class BedrockLegacyBlockCatalog
{
    ...
    private static readonly Dictionary<string, ushort> ByIdentifier = BuildLookup();

    public static string? IdentifierForNumericId(ushort id) => id < Identifiers.Length ? Identifiers[id] : null;
    public static ushort? NumericIdForIdentifier(string identifier)
    {
    ...
    private static Dictionary<string, ushort> BuildLookup()
    {
        ...
        for (ushort id = 0; id < Identifiers.Length; id++) result[Identifiers[id]] = id;
        result["minecraft:grass_block"] = 2;
        result["minecraft:oak_planks"] = 5;
        result["minecraft:oak_sapling"] = 6;
        result["minecraft:oak_log"] = 17;
        result["minecraft:oak_leaves"] = 18;
        result["minecraft:short_grass"] = 31;
        result["minecraft:piston_arm_collision"] = 34;
        result["minecraft:white_wool"] = 35;
        result["minecraft:dandelion"] = 37;
        result["minecraft:poppy"] = 38;
        result["minecraft:smooth_stone_double_slab"] = 43;
        result["minecraft:smooth_stone_slab"] = 44;
        result["minecraft:oak_fence"] = 85;
        result["minecraft:invisible_bedrock"] = 95;
        result["minecraft:infested_stone"] = 97;
        result["minecraft:stone_bricks"] = 98;
        result["minecraft:oak_fence_gate"] = 107;
        result["minecraft:lily_pad"] = 111;
        result["minecraft:trip_wire"] = 132;
        result["minecraft:skeleton_skull"] = 144;
        result["minecraft:oak_double_slab"] = 157;
        result["minecraft:oak_slab"] = 158;
        result["minecraft:white_terracotta"] = 159;
        result["minecraft:white_stained_glass_pane"] = 160;
        result["minecraft:acacia_leaves"] = 161;
        result["minecraft:acacia_log"] = 162;
        result["minecraft:sea_lantern"] = 169;
        result["minecraft:white_carpet"] = 171;
        result["minecraft:sunflower"] = 175;
        result["minecraft:red_sandstone_double_slab"] = 181;
        result["minecraft:red_sandstone_slab"] = 182;
        result["minecraft:hard_white_stained_glass_pane"] = 191;
        result["minecraft:dirt_path"] = 198;
        result["minecraft:item_frame"] = 199;
        result["minecraft:colored_torch_red"] = 202;
        result["minecraft:colored_torch_blue"] = 204;
        result["minecraft:undyed_shulker_box"] = 205;
        result["minecraft:white_shulker_box"] = 218;
        result["minecraft:white_concrete"] = 236;
        result["minecraft:white_concrete_powder"] = 237;
        result["minecraft:compound_creator"] = 238;
        result["minecraft:white_stained_glass"] = 241;
        result["minecraft:moving_block"] = 250;
        result["minecraft:hard_white_stained_glass"] = 254;
        return result;
    }
}
