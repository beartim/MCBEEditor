...
final class BlocktopographTests: XCTestCase {
    ...
    func testWorldCommandStrictParsing() throws {
        ...
        XCTAssertNoThrow(try WorldCommandParser.parse("tickingarea add circle overworld 0 0 4 0 Circle 0"))
        ...
        XCTAssertThrowsError(try WorldCommandParser.parse("tickingarea add circle overworld 0 0 5 0 TooLarge 0"))
