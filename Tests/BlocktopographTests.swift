...
final class BlocktopographTests: XCTestCase {
    ...
    func testWorldCommandStrictParsing() throws {
        ...
        XCTAssertNoThrow(try WorldCommandParser.parse("give minecraft:cow minecraft:redstone_wire 97 NULL"))
        XCTAssertNoThrow(try WorldCommandParser.parse("give minecraft:cow minecraft:lit_smoker 99 'Compound'\"tag\"=\"{'Byte'\"Unbreakable\"=\"1\"}\",'Short'\"Damage\"=\"1\""))
        ...
        XCTAssertNoThrow(try WorldCommandParser.parse("tickingarea add circle overworld 0 0 Circle 0"))
        ...
        XCTAssertThrowsError(try WorldCommandParser.parse("tickingarea add circle overworld 0 0 5 0 TooManyCoordinates 0"))
        XCTAssertThrowsError(try WorldCommandParser.parse("teleport minecraft:cow overworld 0 64 0"))
        ...
        XCTAssertThrowsError(try WorldCommandParser.parse("give @s minecraft:stone 1"))
