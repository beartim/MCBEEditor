...
enum BedrockEntityCommonNBT {
    static func tags(
        ...
        [
            ...
            NBTNamedTag(name: "Age", value: .int(0)),
            ...
            NBTNamedTag(name: "FireImmune", value: .byte(0)),
            NBTNamedTag(name: "HasBoundOrigin", value: .byte(0)),
            NBTNamedTag(name: "HasCollision", value: .byte(1)),
            NBTNamedTag(name: "HasGravity", value: .byte(1)),
            NBTNamedTag(name: "HasOwner", value: .byte(0)),
            ...
            NBTNamedTag(name: "LinksTag", value: .list(.compound, [])),
            ...
            NBTNamedTag(name: "ShowBottom", value: .byte(1)),
