...
require_fixed 'coordinate <= automaticUpperBound && !block.primaryState.isAir' 'Sources/UI/BlockAxisPickerViewController.swift' 'X/Z picker must default to the largest non-air coordinate not exceeding the rendered plane while retaining +128 manual rows'
