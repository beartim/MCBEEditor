...
require_fixed 'let projectionDistance: Int64 = mode == .xray ? 128 : 127' 'Sources/UI/WorldMapViewController.swift' 'all-loaded X/Z X-ray export must include current X/Z through X/Z-128 inclusive'
